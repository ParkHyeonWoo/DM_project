...
public class BoardDTO {
	...
	public int getRune_id() {
		return rune_id;
	}
	public void setRune_id(int rune_id) {
	...
	public String getRune_name_kr() {
		return rune_name_kr;
	}
	public void setRune_name_kr(String rune_name_kr) {
		this.rune_name_kr = rune_name_kr;
	}
